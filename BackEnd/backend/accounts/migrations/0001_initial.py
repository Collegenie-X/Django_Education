# Generated by Django 4.2.9 on 2024-07-29 05:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firebase_uid', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('subscription_level', models.CharField(choices=[('free', 'Free'), ('premium', 'Premium')], default='free', max_length=20)),
                ('recharge_credits', models.IntegerField(default=0)),
